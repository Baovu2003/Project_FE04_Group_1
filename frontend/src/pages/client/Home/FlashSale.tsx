...
import { LeftOutlined, RightOutlined, ShoppingCartOutlined, ClockCircleOutlined } from '@ant-design/icons';
...
const FlashSale = () => {
    ...
    const CountdownTimer: React.FC<{ endTime: string; productId: string }> = ({ endTime, productId }) => {
                            ...
                            <div key={product._id} className="product-card-wrapper">
                                ...
                                >
                                    ...
                                    {product.flashSaleStart && product.flashSaleEnd && (
                                        <CountdownTimer endTime={product.flashSaleEnd} productId={product._id} />
                                    )}
