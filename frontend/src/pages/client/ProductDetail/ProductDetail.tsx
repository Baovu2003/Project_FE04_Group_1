...
import { Layout, Row, Col, Card, Image, Typography, Tag, InputNumber, Button, Carousel, Divider } from 'antd';
    ...
    <Layout>
      <Content style={{ padding: '0 50px' }}>
        <Row gutter={[24, 24]}>
          <Col span={10}>
            <Card bordered={false}>
              <Image src={productImages[0]} alt="Product" />
              <div style={{ position: 'absolute', top: 10, right: 10, background: '#00a2ae', color: 'white', padding: '2px 8px', borderRadius: '50%' }}>
                x12
              </div>
              <Carousel autoplay>
          ...
          <Col span={14}>
            <Card bordered={false}>
              ...
              <Title level={3}>[Hộp 12 Gói] Thức Ăn Cho Mèo WHISKAS 1+ years Vị Cá Ngừ, Gà 80g/Gói</Title>
              <Text type="secondary">Đã bán 10</Text>
              <Title level={2} style={{ color: '#ff424e' }}>144.000đ</Title>
              <Text delete type="secondary">161.000đ</Text>
              ...
              <Button type="link" style={{ padding: 0 }}>Đổi</Button>
              <br />
              <Text type="success">
              ...
              <Button>Mua trước trả sau</Button>
